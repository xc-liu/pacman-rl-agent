...
def generateMaze(seed = None):
  ...
  skip = make_with_prison(maze, depth=0, gaps=9, vert=True, min_width=1, gapfactor=gapfactor)
  # skip = make_with_prison(maze, depth=0, gaps=4, vert=True, min_width=3, gapfactor=gapfactor)
  maze.to_map()
